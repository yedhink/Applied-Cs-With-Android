		...
		public void afterTextChanged(Editable s) {
			...
			for (Map.Entry<String, ArrayList<String>> entry : map.entrySet()) {
				...
				for (String val : valueList) {
					// we dont want to redisplay the usernewStr as an anagram
			...
			if (newStr.matches("")) {
				Toast.makeText(AnagramsActivity.this, R.string.no_text, Toast.LENGTH_SHORT).show();
			...
			try {
				...
				Toast.makeText(AnagramsActivity.this, R.string.null_excep, Toast.LENGTH_SHORT).show();
			}
			 */
		}
	}
